                    ...
                    <form wire:submit.prevent="save">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input wire:model.live.debounce.300ms="nik" id="nik" class="block mt-1 w-full" type="text" name="nik" required autofocus />
                            ...
                            <div>
                                ...
                                <x-text-input wire:model="employee_name" id="employee_name" class="block mt-1 w-full bg-gray-100 dark:bg-gray-700" type="text" name="employee_name" />
