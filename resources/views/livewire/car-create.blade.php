    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Buat Corrective Action Report (CAR)') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- Display RCA and Incident Info --}}
                    <div class="mb-6 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                        <h3 class="font-semibold text-lg mb-2">Informasi Laporan Terkait</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div>
                                <span class="font-bold text-gray-500">Insiden:</span>
                                <p>{{ $rca->accident->description }}</p>
                            </div>
                            <div>
                                <span class="font-bold text-gray-500">Analisis Akar Masalah (RCA):</span>
                                <p>{{ $rca->summary }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            <div>
                                ...
                                <x-text-input wire:model="number" id="number" class="block mt-1 w-full bg-gray-100 dark:bg-gray-700" type="text" name="number" readonly />
                            </div>
                            <div>
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('rca.show', $rca) }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
                                {{ __('Batal') }}
                            </a>
